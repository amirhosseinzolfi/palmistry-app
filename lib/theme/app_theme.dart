...
class AppColors {
  ...
  static const Color neonCelestialBlue =
      Color(0xFF38BDF8); // Celestial Sky Blue
  ...
  static const Color textPrimary =
      Color(0xFFF8FAFC); // Clean crisp off-white (Highest contrast)
  static const Color textSecondary =
      Color(0xFFCBD5E1); // High contrast light blue-gray for body text
  static const Color textMuted = Color(0xFF818CF8); // Muted cosmic violet-gray
  static const Color textAccentCyan =
      Color(0xFF38BDF8); // Celestial cyan text highlight
  static const Color textAccentPurple =
      Color(0xFFC084FC); // Purple text highlight
  ...
  static const Color lineHeart =
      Color(0xFFF43F5E); // Neon Crimson/Rose (Heart Line)
  ...
  static const Color lineFate =
      Color(0xFFA855F7); // Neon Lavender/Purple (Fate Line)
  static const Color lineSun =
      Color(0xFF818CF8); // Soft Cosmic Indigo (Sun Line)
  static const Color lineMercury =
      Color(0xFF06B6D4); // Neon Cyan (Mercury Line)
  static const Color lineMarriage =
      Color(0xFFEC4899); // Neon Pink (Marriage Line)
  static const Color lineGirdle =
      Color(0xFFFB7185); // Neon Rose (Girdle of Venus)
  static const Color lineIntuition =
      Color(0xFF84CC16); // Neon Lime (Intuition Line)
  static const Color lineMars = Color(0xFFF97316); // Neon Orange (Mars Line)
  static const Color lineInfluence =
      Color(0xFF0284C7); // Deep Neon Blue (Influence Line)
  ...
  static const Color lineBracelets =
      Color(0xFFFB923C); // Coral Orange (Wrist Lines)
  static const Color ringSolomon = Color(0xFF22C55E); // Emerald (Solomon Ring)
  static const Color ringSaturn =
      Color(0xFF9333EA); // Deep Violet (Saturn Ring)
  ...
  static const Color mountApollo =
      Color(0xFF818CF8); // Celestial Indigo (Apollo/Sun)
  static const Color mountMercury = Color(0xFF06B6D4); // Cyan (Mercury)
  static const Color mountMarsLower =
      Color(0xFF10B981); // Emerald (Mars Positive)
  static const Color mountMarsUpper =
      Color(0xFFF97316); // Orange (Mars Negative)
  static const Color mountMarsPlain =
      Color(0xFF38BDF8); // Sky Blue (Plain of Mars)
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        bodyLarge:
            GoogleFonts.vazirmatn(height: 1.65, color: AppColors.textSecondary),
        bodyMedium:
            GoogleFonts.vazirmatn(height: 1.65, color: AppColors.textSecondary),
        bodySmall:
            GoogleFonts.vazirmatn(height: 1.5, color: AppColors.textMuted),
      ),
